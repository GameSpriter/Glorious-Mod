package com.GameSpriter.Glorious.world;
...
public class WorldGenShinyTree extends WorldGenBirchTree {

	private static final IBlockState LOG = GloriousBlocks.shinyWood.getDefaultState();
	...
	private static final boolean useExtraRandomHeight = false;
	
	public WorldGenShinyTree(boolean notify, boolean useExtraRandomHeightIn) {
		super(notify, useExtraRandomHeightIn);
		System.out.println("World gen started");
	}
                            ...
                            for (int k1 = position.getZ() - l2; k1 <= position.getZ() + l2; ++k1)
                            {
                                ...
                                if (Math.abs(j1) != l2 || Math.abs(l1) != l2 || rand.nextInt(2) != 0 && k2 != 0)
                                {
                                    ...
                                    if (state2.getBlock().isAir(state2, worldIn, blockpos) || state2.getBlock().isAir(state2, worldIn, blockpos))
                                    {
                                        ...
                                        System.out.println("Block "+ LEAF +" at position "+ blockpos +".");
                                    }
                                }
                            }
                        }
